...
public class ModifiedWarehousesList extends JFrame {
    private JTable table;
    private List<Warehouse> warehouses;

    public ModifiedWarehousesList() {
    ...
    private void displayRowInfo(int row) {
        ...
        JDialog dialog = new JDialog(this, "Warehouse Information", true);
